...
#define NEWHOPE_INDCPA_MSGBYTES        32
#define NEWHOPE_INDCPA_PUBLICKEYBYTES  (NEWHOPE_POLYBYTES + NEWHOPE_SYMBYTES)
#define NEWHOPE_INDCPA_SECRETKEYBYTES  (NEWHOPE_POLYBYTES)
#define NEWHOPE_INDCPA_CIPHERTEXTBYTES (NEWHOPE_POLYBYTES + NEWHOPE_POLYCOMPRESSEDBYTES)

#define NEWHOPE_PUBLICKEYBYTES NEWHOPE_INDCPA_PUBLICKEYBYTES
#define NEWHOPE_SECRETKEYBYTES (NEWHOPE_INDCPA_SECRETKEYBYTES + NEWHOPE_INDCPA_PUBLICKEYBYTES + 32 + NEWHOPE_SYMBYTES)
#define NEWHOPE_CIPHERTEXTBYTES (NEWHOPE_INDCPA_CIPHERTEXTBYTES + NEWHOPE_INDCPA_MSGBYTES)  /* Second part is for Targhi-Unruh */
