...
#Keccak f-1600 for MIPS64, big-endian
...
.macro ROUND
  ...
  DO_BC $v1 $v0 $s6 $t6 $t9 $s1 /* v1 = bco = Ago, Abo, Ako, Amo, Aso */
  DO_BC $v0 $s5 $t0 $t2 $t3 $ra /* v0 = bcu = Agu, Abu, Aku, Amu, Asu */
